...
oldest-animal selection with Comparator.comparing(Animal::getAge). importAnimals is currently long and repeats
the same skip bookkeeping block multiple times; extract shared skip handling and smaller
